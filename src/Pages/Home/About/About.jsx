    ...
    return (
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row ">
                ...
                <img src={parts} className="absolute right-5 top-1/2 max-w-sm rounded-lg shadow-2xl w-1/2 border-8 border-white " />
                </div>
                <div className='w-1/2 space-y-6 p-4'>
                    <h1 className='text-3xl font-semibold text-[#FF3811]'>About Us</h1>
